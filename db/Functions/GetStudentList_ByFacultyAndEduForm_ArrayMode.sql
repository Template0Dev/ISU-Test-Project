...
CREATE OR REPLACE FUNCTION public.get_students_list__by_faculties_and_edu_forms(
    ...
    RETURNS TABLE(faculty_name character, education_form character, student_group character, on_contract boolean, student_isu_id integer, student_surname text, student_name text, student_patronymic text) 
    LANGUAGE 'sql'
    COST 100
